...
#'  \item{ sex }{ character: sex of applicant (female or male) }
#'  \item{ race }{ character: race of applicant (black or white) }
#'  \item{ call }{ integer: whether a callback was made (1 = yes, 0 = no) }
#' }
#'
#'
#' @details
